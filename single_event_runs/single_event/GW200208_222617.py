...
V1.load_data(gps, start_pad, end_pad, fmin, fmax, psd_pad=16, tukey_alpha=0.2)
...
Mc_prior = Unconstrained_Uniform(5.0, 80.0, naming=["M_c"])
...
dL_prior = Unconstrained_Uniform(0.0, 20000.0, naming=["d_L"])
